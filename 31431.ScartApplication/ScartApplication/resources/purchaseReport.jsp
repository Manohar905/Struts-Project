...
<%@page import="roseindia.email.SendProductConfirmationMail"%>
<%@page import="dao.tables.Product"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.opensymphony.xwork2.ActionContext"%>
<%@taglib prefix="s" uri="/struts-tags"%>
<%@page import="dao.domain.ProductDao"%>
<%@page import="roseindia.model.ShoppingCart"%>
...
<%@page import="roseindia.pdf.CreateBill"%>
<%@page import="dao.domain.OrderDao"%>
<%@page import="dao.tables.Order"%>

<%@page import="java.util.Date"%>
<%@page import="roseindia.action.orderItems.OrderItems"%>
